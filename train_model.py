...
def train_model():
    ...
    if restore_epoch != None:
                generator.load_state_dict(torch.load("/content/gdrive/MyDrive/ColabNotebooks/CSANet/model_csa/model2/epoch_" + str(restore_epoch) + ".pth"), strict=False)
    # Losses
    ...
    for epoch in range(num_train_epochs):
        ...
        for i in range(len(train_loader)):
            ...
            if i == 0:
                ...
                generator.eval().cpu()
                torch.save(generator.state_dict(), "/content/gdrive/MyDrive/ColabNotebooks/CSANet/model_csa/model2/epoch_" + str(epoch) + ".pth")
                ...
                with torch.no_grad():
                    ...
                    for j in range(len(visual_loader)):
                        ...
                        imageio.imwrite("/content/gdrive/MyDrive/ColabNotebooks/CSANet/results_csa/model2/img_" + str(j) +  "_epoch_" +
