...
dataset_dir='/content/gdrive/MyDrive/ColabNotebooks/pynet_fullres/dataset/test/full_resolution'
...
generator.load_state_dict(torch.load("/content/gdrive/MyDrive/ColabNotebooks/CSANet/model_csa/86.pth"), strict=False)
...
with torch.no_grad():
  ...
  for j in range(len(visual_loader)):
    ...
    imageio.imwrite("/content/gdrive/MyDrive/ColabNotebooks/CSANet/results_csa/" + str(j) + ".xxxjpg", enhanced)
